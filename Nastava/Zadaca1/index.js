const DATA = {
  movies: [
    ...
    { id:'m5',  title:'The Dark Knight',                year:2008, rating:9.1, genre:['Thriller','Drama'],    duration:'152 min', director:'Chrstiopher Nolan',       cast:'Greta Lee, Teo Yoo',                  badge:'',       color:'#1a3a6b', img:'',  desc:'When a menace known as the Joker wreaks havoc and chaos on the people of Gotham, Batman, James Gordon and Harvey Dent must work together to put an end to the madness.' },
    { id:'m6',  title:'Project Hail Mary',      year:2026, rating:8.5, genre:['Dark Comedy','Sci-Fi'],        duration:'156 min', director:'Phil Lord, Christopher Miller',   cast:'Ryan Gosling, James Ortiz',    badge:'',       color:'#2a2a2a', img:'',  desc:'Science teacher Ryland Grace wakes up alone on a spaceship light-years from Earth. As his memory returns, he uncovers a mission to stop a mysterious substance killing the sun, and save Earth. An unexpected friendship may be the key.' },
    { id:'m7',  title:'Avatar',                  year:2009, rating:7.9, genre:['Actionr','Adventure'],   duration:'162 min', director:'James Cameron',   cast:'Sam Worthington, Sigourney Weaver',         badge:'new',    color:'#1a1a4b', img:'',  desc:'A paraplegic Marine dispatched to the moon Pandora on a unique mission becomes torn between following his orders and protecting the world he feels is his home.' },
    { id:'m8',  title:'The Avengers',          year:2024, rating:8.0, genre:['Action','Sci-Fi'],     duration:'143 min', director:'Joss Whedon',    cast:'Robert Downey Jr., Chris Evans, Scarlett Johansson',    badge:'',       color:'#2a4a2a', img:'',  desc:'Earth s mightiest heroes must come together and learn to fight as a team if they are going to stop the mischievous Loki and his alien army from enslaving humanity.' },
    { id:'m9',  title:'Alien: Romulus',            year:2024, rating:7.1, genre:['Cyberpunk','Alien Invasion'],    duration:'119 min', director:'Fede Álvarez',      cast:'Cailee Spaeny, David Jonsson',         badge:'new',    color:'#1a2a1a', img:'',  desc:'A group of young space colonizers encounter a terrifying life form in an abandoned space station.' },
    { id:'m10', title:'Spider-Man',          year:2002, rating:7.4, genre:['Superhero','Adventure'],    duration:'121 min', director:'Sam Raimi',     cast:'Tobey Maguire',     badge:'top',    color:'#6b3a0a', img:'',  desc:'After being bitten by a genetically-modified spider, a shy teenager gains spider-like abilities that he uses to fight injustice as a masked superhero and face a vengeful enemy.' },
    { id:'m11', title:'Nuremberg',              year:2025, rating:7.4, genre:['Docudrama','Epic'], duration:'148 min', director:'James Vanderbilt',       cast:'Rami Malek,Russell Crowe',              badge:'top',    color:'#1a4a6b', img:'',  desc:'A WWII psychiatrist evaluates Nazi leaders before the Nuremberg trials, growing increasingly obsessed with understanding evil as he forms a disturbing bond with Hermann Göring.' },
    ...
    { id:'m19', title:'Ant-Man',                    year:2015, rating:7.5, genre:['Comedy','Action'],  duration:'117 min', director:'Peyton Reed',        cast:'Paul Rudd, Michael Douglas',         badge:'top',    color:'#2a0a4a', img:'',  desc:'Armed with a super-suit with the astonishing ability to shrink in scale but increase in strength, cat burglar Scott Lang must embrace his inner hero and help his mentor, Dr. Hank Pym, pull off a plan that will save the world.' },
    { id:'m20', title:'Iron Man 3',                 year:2013, rating:7.1, genre:['Superhero','Adventure'],    duration:'130 min', director:'Shane Black',     cast:'Robert Downey Jr., Guy Pearce',       badge:'new',    color:'#1a0a0a', img:'',  desc:'When Tony Stark s world is torn apart by a formidable terrorist called the Mandarin, he starts an odyssey of rebuilding and retribution.' },
  ],
  series: [
